                ...
                <tr>
                    <td style="font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; text-align:center">
                        <h1
                            ...
                            Your One-Time Password from Team AST</h1>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 100%;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        style="padding: 30px 13px 10px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;text-align: center;">
                        <p style="margin: 0;">Here is your verification code for <b style="color:#293845">Day
                                ${parseInt(days) + 1}</b> from Team AST.</p>
                    </td>
                </tr>
                <tr>
                    <td align="left" bgcolor="#ffffff">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <p style="margin: 0; padding-top: 10px; font-size:14px;">Please check your attendance and work
                            submission at the following link: <a href="https://asteam-attendance.vercel.app/scrummaster"
                                target="_blank">AST Team Attendance and Submission Portal</a></p>
                    </td>
                </tr>
                <tr>
                    <td align="left" bgcolor="#ffffff"
